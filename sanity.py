...
driver = webdriver.Remote(
    ...
    desired_capabilities={
      ...
      "appPackage": "com.xxx.internal.debug",
      "udid": "<UDID 기입>", # BeWhy 9TSDU17B07000371
      "noReset": "true",
     "appActivity": "com.xxx.SplashActivity"
})
#첫 스플래쉬
driver.implicitly_wait(5)
driver.find_element_by_id("com.xxx.internal.debug:id/info_btn_close").click()
...
def Login(usedId, userPw):
    ...
    driver.find_element_by_id("com.xxx.internal.debug:id/btn_login").click()
    ...
    driver.find_element_by_id("com.xxx.internal.debug:id/button").click()
...
def WalletSelect():
    driver.find_element_by_accessibility_id("계정").click()
    driver.find_element_by_id("com.xxx.internal.debug:id/add_wallet").click()
...
def BTC_ETH_BUY():
    ...
    read_price = driver.find_element_by_id("com.xxx.internal.debug:id/order_price_edit_text")
    ...
    input_price = driver.find_element_by_id("com.xxx.internal.debug:id/input_aid_edit_text")
    input_price.clear()
    input_price.send_keys(set_price_half)

    driver.back()
    driver.find_element_by_id("com.xxx.internal.debug:id/btn_trade").click()
    second_pwd("<지갑 패스워드>")
...
def second_pwd(walletPw):
    driver.find_element_by_id("com.xxx.internal.debug:id/input").send_keys(walletPw)
    driver.find_element_by_id("com.xxx.internal.debug:id/button").click()
